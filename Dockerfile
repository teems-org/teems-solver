...
LABEL org.opencontainers.image.version="0.91"
...
RUN cd ${TEEMS_TMP} \
    ...
    # permissions for the bin_parser directory
    && chown -R 1000:1000 /opt/teems-parser \
    && chmod -R 755 /opt/teems-parser \
    # cleanup
    && rm -rf ${TEEMS_TMP}
